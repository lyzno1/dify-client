...
export function ThinkBlock({ content, isStreaming, className }: ThinkBlockProps) {
    ...
    return (
        ...
        >
            <CollapsibleTrigger className="flex items-center justify-between px-4 py-2 bg-muted/50 border-b select-none w-full hover:bg-muted/60 transition-colors cursor-pointer">
